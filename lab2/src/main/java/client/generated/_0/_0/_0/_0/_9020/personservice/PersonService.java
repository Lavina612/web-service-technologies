 ...
 * 
 */
@WebServiceClient(name = "PersonService", targetNamespace = "http://0.0.0.0:9020/PersonService", wsdlLocation = "http://localhost:9020/PersonService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName PERSONSERVICE_QNAME = new QName("http://0.0.0.0:9020/PersonService", "PersonService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:9020/PersonService?wsdl");
    ...
    public PersonWebService getPersonWebServicePort() {
        return super.getPort(new QName("http://0.0.0.0:9020/PersonService", "PersonWebServicePort"), PersonWebService.class);
    }
    ...
    public PersonWebService getPersonWebServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://0.0.0.0:9020/PersonService", "PersonWebServicePort"), PersonWebService.class, features);
    }
